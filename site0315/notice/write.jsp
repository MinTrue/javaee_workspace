...
<script>
  ...
  스크립트 기술인 백앤드 기술인 jsp에게 맡기자 (요청)
  */
  function send(){
    //폼양식을, 서버측에 존재하는 페이지인 regist.jsp 에게 전송해보자
    let form1 = document.getElementById("form1");
    form1.action ="/notice/regist.jsp"; //폼전송 대상
    form1.method="post"; // 서버에 어떤 요청을 할때, 전송할 데이커가 있다면 post 방식으로
                         // 요청을 시도해야한다(HTTP 프로토콜에서 그러하다.)
    form1.submit(); //전송 행위
...
<div class="container">
  <form id="form1" method="post">
    <!--
      id 와 name 공통점: 문섣내의 요소를 구분하기 위한 용도
                차이점: name은 중복을 허용하고 + 서버에 전송시 전송 파라티머 역할까지 수행
