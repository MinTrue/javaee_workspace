...
<%
	...
	int blockSize = 10; //블럭당 보여질 페이지 개수
	int currentPage =1; //현재유저가 보는 페이지
	//유저가 페이지 번호를 선택할 경우, 1이 아닌 유저가 전송한 파라미터로 대체하자
	if(request.getParameter("currentPage") !=null){
		currentPage = Integer.parseInt(request.getParameter("currentPage"));		
	}
	int firstPage= currentPage -(currentPage-1)%blockSize; //블렁당 for문의 시작 페이지 값
					...
					<td colspan="6" align="center">
						<div class="row">
							<ul class="pagination">
							  ...
							  <%} else{ %>
							  <li class="page-item"><a class="page-link" href="javascript:alert('다음 페이지가 없습니다.')">Next</a></li>
							  <%} %>
							</ul>	
