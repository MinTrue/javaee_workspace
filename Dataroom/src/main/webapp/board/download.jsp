...
<%
	...
	//application 내자 객체는 javaee api 에서의 자료형은 ServletContext 이다.
	...
	//스트림을 생성했으니, 응답정보르 구성해보자, 응답정보는 HTTP 프로토콜에 의해 머리와 몸체로 구성
	
	//어플리케이션 내장객체로 하여금 마임타입을 조사해라
	//text.html, application/json, image/jpge.. , 알수없는 마임타입도 있다.
	String mimeType = application.getMimeType(realPath+filename);
	out.print("당신이 선택한 마임타입은"+mimeType);
