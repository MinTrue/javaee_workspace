...
public class BoardDAO {
	...
	public int update(Board board) {
		...
		try {
			pstmt = con.prepareStatement(sql);
			pstmt.setString(1, board.getTitle());// dto에서 title을 꺼내어 바인드 변수에 대입
			pstmt.setString(2, board.getWriter());// dto에서 writer을 꺼내어 바인드 변수에 대입
			pstmt.setString(3, board.getContent());// dto에서 content을 꺼내어 바인드 변수에 대입
			pstmt.setInt(4, board.getBoard_idx());// dto에서 board_idx을 꺼내어 바인드 변수에 대입
